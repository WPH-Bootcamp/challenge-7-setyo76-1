...
import type { Restaurant, MenuItem, ApiResponse } from '@/shared/types';
...
export const restaurantsApi = {
  getRestaurants: async (params?: {
    ...
    // Endpoint: /resto (bukan /api/resto karena baseURL sudah include /api)
  ...
  getRecommendedRestaurants: async (
    ...
    try {
      const response = await apiClient.get('/resto/recommended', {
        params: { page, limit },
      });
      ...
      const fallbackResponse = await apiClient.get('/resto', {
        params: { page, limit },
      });
